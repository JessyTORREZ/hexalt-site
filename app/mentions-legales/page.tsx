  ...
  <>
    ...
    <div className="px-6 md:px-16 lg:px-32 py-12 max-w-5xl mx-auto font-body text-gray-700 leading-relaxed">
      ...
      <p className="mb-10">
        ...
        l'économie numérique, nous vous informons des mentions légales suivantes
        :
      </p>
      ...
      <section className="mb-10">
        ...
        <p>
          ...
          est protégé par le droit d'auteur. Toute reproduction, distribution,
          modification ou utilisation, même partielle, est interdite sans
